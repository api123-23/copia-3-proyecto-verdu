...
export const CAMPOS_GE: (keyof InformeGrupoElectrogeno)[] = [
  ...
  "ge_motor_detenido_dca_anticongelante",
  "ge_motor_detenido_ajuste_inyectores",
  "ge_motor_detenido_calibre_inyectores",
...
export const CAMPO_LABELS_GE: Record<keyof InformeGrupoElectrogeno, string> = {
  ...
  ge_motor_detenido_dca_anticongelante: "DCA Anticongelante",
  ge_motor_detenido_ajuste_inyectores: "Ajuste Inyectores",
  ge_motor_detenido_calibre_inyectores: "Calibre Inyectores",
